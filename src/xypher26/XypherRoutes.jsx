...
// css
import "./xypher.css"
import "./XypherApp.css"
import "./xypher-globals.css"
...
function ProtectedRoute({ children }) {
  ...
  if (!isAuthenticated) {
    return <Navigate to="/xypher26/login" replace />;
  }
      ...
      >
        <Routes>
          ...
          <Route path="signup" element={
            !loading && isAuthenticated ? <Navigate to="/xypher26/events" replace /> : <Signup />
          } />
...
export default function XypherRoutes() {
  return (
    <div className="xypher-app">
      <AuthProvider>
        <AppRoutes />
      </AuthProvider>
    </div>
