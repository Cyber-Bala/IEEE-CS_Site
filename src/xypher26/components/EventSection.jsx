...
const events = [
  {
    ...
    eventHead: { name: "Keerthana", phone: "+91 6205054440" },
    ...
    details: [
      ...
      { label: "Registration Fee (Per Team)", value: "₹250 (IEEE) / ₹300 (Non-IEEE)" },
  ...
  },
  {
    ...
    eventHead: { name: "Tanushri", phone: "+91 75388 49650" },
    ...
    details: [
      ...
      { label: "Registration Fee  (Per Team)", value: "₹125 (IEEE) / ₹175 (Non-IEEE)" },
  ...
  },
  {
    ...
    eventHead: { name: "Athira", phone: "+91 89034 00190" },
    ...
    details: [
      ...
      { label: "Registration Fee  (Per Team)", value: "₹150 (IEEE) / ₹175 (Non-IEEE)" },
  ...
  },
  {
    ...
    eventHead: { name: "Piraisoodan", phone: "+91 80568 92547" },
  ...
  },
  {
    ...
    eventHead: { name: "Mridhula", phone: "+91 98403 29629" },
    description: "Act as startup engineers with limited funding. Bid on technical resources, strategize under budget, and build a working prototype.",
    detailTitle: "Bid & Build",
    detailDescription: "The objective of this event is to provide students with practical exposure to resource-constrained software development and decision-making. Participants act as startup engineers with limited funding, receiving a fixed virtual budget to select technical resources, plan their project, and develop a prototype.",
    ...
    about: [
      "Participants will analyze available technical resources, make strategic decisions under budget constraints, and select appropriate tools.",
      "Teams receive a fixed virtual budget and must bid for resources in a live auction.",
      "Resources include Public APIs, Kaggle datasets, Bootstrap UI, and GitHub templates.",
      "After the auction, teams plan their project and develop a prototype using only the selected resources.",
    ],
    rules: [
      "Teams must consist of 2–3 members.",
      "Teams act as startup engineers with limited funding and must not exceed their virtual budget.",
      "Participants must build a functional project using limited resources and present their solution, justifying their choices.",
      "Tools allowed: Python / JavaScript, VS Code, Browser tools.",
    ],
    prizes: [
      { place: "1st Place", amount: "₹3,000" },
      { place: "2nd Place", amount: "₹2,000" },
    ...
    eventFlow: [
      { phase: "Round 1: Screening", time: "9:00 – 9:45 AM", desc: "20–30 MCQs on programming, APIs, logic. Top teams shortlisted." },
      { phase: "Round 2: Auction & Dev", time: "9:45 AM – 2:00 PM", desc: "Auction resources, plan and build project, submit prototype." },
      { phase: "Round 3: Presentation", time: "2:00 – 2:30 PM", desc: "5 min presentation per team to showcase their solution." },
      { phase: "Round 4: Results", time: "2:30 – 3:00 PM", desc: "Winners announced." },
    ],
  },
  {
    number: "V",
    ...
    eventHead: { name: "Shivani", phone: "+91 99625 71492" },
  ...
  },
  {
    ...
    eventHead: { name: "Viknesh", phone: "+91 78455 63777" },
  ...
  },
  {
    ...
    eventHead: { name: "Reshma", phone: "+91 98844 53399" },
