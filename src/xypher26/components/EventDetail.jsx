        ...
        <div className="flex flex-col lg:flex-row pt-32 pb-12">
          ...
          <div className="flex-1 lg:pr-12">
            ...
            <div className="flex flex-col items-center px-6 md:px-16 pt-8 pb-12">
              ...
              {/* Title */}
              <motion.h1
                className="font-cinzel text-4xl md:text-6xl font-bold text-foreground text-glow text-center mb-4"
              ...
              {event.day && (
                <motion.div
                  ...
                  <div className="flex items-center gap-3 bg-primary/10 border-2 border-primary/50 px-6 py-2.5 rounded-full shadow-[0_0_20px_rgba(201,162,39,0.15)]">
                    <span className="text-primary text-sm md:text-base font-bold uppercase tracking-[0.2em] font-display">
                      {event.day}
                    </span>
                    <span className="w-px h-5 bg-primary/40" />
                    <span className="text-foreground text-sm md:text-base font-semibold font-display tracking-wide">
                      {event.date}
                    </span>
                  </div>
