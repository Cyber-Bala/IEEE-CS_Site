...
function HeroSection() {
  ...
  return (
    <section
      ...
      className="w-full h-screen min-h-[100dvh] flex items-center justify-center overflow-hidden bg-[#0a0a0a]"
    >
      {/* Video Background with parallax - Ensure it covers entirely by lightly scaling */}
      <motion.div
      ...
      >
        <video
          ...
          onTimeUpdate={(e) => {
            if (e.target.duration && e.target.duration - e.target.currentTime < 0.2) {
      ...
      >
        ...
        >
          <MagneticButton
            as="button"
            onClick={() => navigate("/xypher26/events")}
